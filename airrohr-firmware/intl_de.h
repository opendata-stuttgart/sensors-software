...
const char INTL_PRESS_CORRECTION[] PROGMEM = "Korrekturwert Druck in Pa";
const char INTL_HUMIDITY_CORRECTION[] PROGMEM = "Korrekturwert Feuchte in %";
...
const char INTL_LOC_ALTI[] PROGMEM = "Sensorhöhe [m] über msl";
