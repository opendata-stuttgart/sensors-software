...
const char INTL_LATITUDE[] = "Latitude";
const char INTL_LONGITUDE[] = "Longitude";
const char INTL_ALTITUDE[] = "Altitude";
const char INTL_DATE[] = "Date";
const char INTL_TIME[] = "Temps";
