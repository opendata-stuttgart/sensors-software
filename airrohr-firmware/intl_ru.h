...
const char INTL_ERSTER_MESSZYKLUS[] PROGMEM = "Еще {v} секунд до первого измерения.";
const char INTL_ZEIT_SEIT_LETZTER_MESSUNG[] PROGMEM = " Секунд после последнего измерения.";
const char INTL_PARTIKEL_LITER[] PROGMEM = "Частицы/ литр";
const char INTL_FEINSTAUB[] PROGMEM = "Датчик пыли";
