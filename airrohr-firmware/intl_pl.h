...
const char INTL_FEINSTAUBSENSOR[] PROGMEM = "Czujnik pyłu zawieszonego";
const char INTL_KONFIGURATION[] PROGMEM = "Konfiguracja";
const char INTL_WLAN_DATEN[] PROGMEM = "Ustawienia WiFi";
const char INTL_WLAN_LISTE[] PROGMEM = "Ładowanie sieci WiFi...";
const char INTL_SPRACHE[] PROGMEM = "Język";
const char INTL_KEINE_NETZWERKE[] PROGMEM =  "Nie znaleziono sieci WiFi";
const char INTL_NETZWERKE_GEFUNDEN[] PROGMEM = "Znalezione sieci: ";
const char INTL_AB_HIER_NUR_ANDERN[] PROGMEM = "Ustawienia zaawansowane (tylko gdy wiesz co robisz)";
const char INTL_SPEICHERN[] PROGMEM = "Zapisz";
const char INTL_SENSOREN[] PROGMEM = "Sensory";
...
const char INTL_FS_WIFI_BESCHREIBUNG[] PROGMEM = "Parametry WiFi w trybie konfiguracji czujnika";
const char INTL_FS_WIFI_NAME[] PROGMEM = "Nazwa sieci";
const char INTL_WEITERE_EINSTELLUNGEN[] PROGMEM ="Więcej ustawień";
...
const char INTL_MESSINTERVALL[] PROGMEM = "Czas między pomiarami (sek.)";
const char INTL_DAUER_ROUTERMODUS[] PROGMEM = "Czas trwania w trybie routera (sek.)";
const char INTL_WEITERE_APIS[] PROGMEM = "Kolejne API";
const char INTL_AN_EIGENE_API_SENDEN[] PROGMEM = "Wysyłaj dane do własnego API";
const char INTL_SERVER[] PROGMEM = "Adres serwera"; 
const char INTL_PFAD[] PROGMEM = "Ścieżka"; 
const char INTL_PORT[] PROGMEM = "Port"; 
const char INTL_BENUTZER[] PROGMEM = "Nazwa użytkownika"; 
const char INTL_PASSWORT[] PROGMEM = "Hasło"; 
const char INTL_SENDEN_AN[] PROGMEM = "Wysyłaj dane do {v}"; 
const char INTL_LESE[] PROGMEM = "Czytaj z {v}";
const char INTL_GERAT_WIRD_NEU_GESTARTET[] PROGMEM = "Ponowne uruchamianie czujnika.";
const char INTL_GERAT_NEU_STARTEN[] PROGMEM = "Uruchom ponownie urządzenie";
const char INTL_CONFIG_LOSCHEN[] PROGMEM = "Usuń zapisaną konfigurację";
const char INTL_SENSOR_NEU_STARTEN[] PROGMEM = "Uruchom ponownie czujnik";
const char INTL_UBERSICHT[] PROGMEM = "Strona startowa";
const char INTL_ZURUCK_ZUR_STARTSEITE[] PROGMEM = "Powrót do strony startowej";
const char INTL_AKTUELLE_WERTE[] PROGMEM = "Obecne wskazania";
const char INTL_KARTE_DER_AKTIVEN_SENSOREN[] PROGMEM = "Mapa aktywnych czujników (link zewnętrzny)";
const char INTL_KONFIGURATION_LOSCHEN[] PROGMEM = "Usunięcie konfiguracji";
const char INTL_KONFIGURATION_WIRKLICH_LOSCHEN[] PROGMEM = "Czy na pewno chcesz usunąć konfigurację?";
const char INTL_LOSCHEN[] PROGMEM = "Usuń";
...
const char INTL_SPEICHERN_UND_NEU_STARTEN[] PROGMEM = "Zapisz i zrestartuj";
...
const char INTL_CONFIG_GELOSCHT[] PROGMEM = "Usunięto konfigurację";
const char INTL_CONFIG_KONNTE_NICHT_GELOSCHT_WERDEN[] PROGMEM = "Konfiguracja nie może zostać usunięta";
const char INTL_CONFIG_NICHT_GEFUNDEN[] PROGMEM = "Nie znaleziono konfiguracji";
const char INTL_ERSTER_MESSZYKLUS[] = "Pozostało {v} sekund do pierwszego pomiaru.";
const char INTL_ZEIT_SEIT_LETZTER_MESSUNG[] = " sekund od ostatniego pomiaru.";
const char INTL_PARTIKEL_LITER[] PROGMEM = "cząsteczek/litr";
const char INTL_FEINSTAUB[] PROGMEM = "pył zawieszony";
const char INTL_TEMPERATUR[] PROGMEM = "temperatura";
const char INTL_LUFTFEUCHTE[] PROGMEM = "wilgotność";
const char INTL_LUFTDRUCK[] PROGMEM = "ciśnienie";
...
const char INTL_SIGNAL[] PROGMEM = "siła sygnału";
const char INTL_QUALITAT[] PROGMEM = "jakość sygnału";
const char INTL_ANZAHL_MESSUNGEN[] PROGMEM = "Liczba pomiarów:";
const char INTL_SENSOR[] PROGMEM = "Czujnik";
const char INTL_PARAMETER[] PROGMEM = "Parametr";
const char INTL_WERT[] PROGMEM = "Wartość";
