# 1 "/var/folders/87/3k516chs3sgcj5l09gbsvngh0000gn/T/tmpnboabj94"
#include <Arduino.h>
# 1 "/Users/PJ/CODES/sensors-software/airrohr-firmware/airrohr-firmware.ino"
# 56 "/Users/PJ/CODES/sensors-software/airrohr-firmware/airrohr-firmware.ino"
#include <WString.h>
#include <pgmspace.h>
...
# 132 "/Users/PJ/CODES/sensors-software/airrohr-firmware/airrohr-firmware.ino"
namespace cfg
{
...
float last_value_IPS_P3 = -1.0;
float last_value_IPS_P4 = -1.0;
float last_value_IPS_P5 = -1.0;
float last_value_IPS_P6 = -1.0;
...
void setup(void);
void loop(void);
#line 658 "/Users/PJ/CODES/sensors-software/airrohr-firmware/airrohr-firmware.ino"
static void display_debug(const String &text1, const String &text2)
{
...
static String IPS_version_date()
{
# 1062 "/Users/PJ/CODES/sensors-software/airrohr-firmware/airrohr-firmware.ino"
...
# 3142 "/Users/PJ/CODES/sensors-software/airrohr-firmware/airrohr-firmware.ino"
static void create_influxdb_string_from_data(String &data_4_influxdb, const String &data)
{
...
static void fetchSensorIPS(String &s)
{
 ...
 if (send_now)
 {
  ...
  last_value_IPS_P3 = -1.0;
  last_value_IPS_P4 = -1.0;
  last_value_IPS_P5 = -1.0;
  last_value_IPS_P6 = -1.0;
...
# 5541 "/Users/PJ/CODES/sensors-software/airrohr-firmware/airrohr-firmware.ino"
   }
...
if (cfg::npm_read)
...
else if (cfg::ips_read)
 {
  ...
  serialIPS.setTimeout((4 * 12 * 1000) / 9600);
 }
 else
 {
#if defined(ESP8266)
