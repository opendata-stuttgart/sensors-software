...
const char INTL_AN_EIGENE_API_RMAP[] PROGMEM = "Sendet Daten an den RMAP-Server";
...
const char INTL_LONGITUDE[] PROGMEM = "Longitude, ein Sechstel mit 5 Dezimalstellen"; 
const char INTL_LATITUDE[] PROGMEM = "Breitengrad, ein Sechstel mit 5 Nachkommastellen"; 
const char INTL_SERVERRMAP[] PROGMEM = "RMAP-Server"; 
const char INTL_STATIONRMAP[] PROGMEM = "Name der RMAP-Station (Slug)"; 
