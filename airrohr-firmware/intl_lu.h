...
const char INTL_FEINSTAUBSENSOR[] PROGMEM = "Reng Stëbspartikelensensor";
const char INTL_KONFIGURATION[] PROGMEM = "Konfiguratioun";
const char INTL_WLAN_DATEN[] PROGMEM = "WiFi Daten";
const char INTL_WLAN_LISTE[] PROGMEM = "WiFi Netzwierker lueden ...";
const char INTL_SPRACHE[] PROGMEM = "Sprooch";
const char INTL_KEINE_NETZWERKE[] PROGMEM =  "Keng Netzwierker fonnt";
const char INTL_NETZWERKE_GEFUNDEN[] PROGMEM = "Netzwierker fonnt: ";
const char INTL_AB_HIER_NUR_ANDERN[] PROGMEM = "Ab hei nëmmen änneren, wann der wësst wat dir maacht";
const char INTL_SPEICHERN[] PROGMEM = "Späicheren";
...
const char INTL_FS_WIFI_BESCHREIBUNG[] PROGMEM = "WiFi Sensor Numm am Konfiguratiounsmodus";
const char INTL_FS_WIFI_NAME[] PROGMEM = "Numm";
const char INTL_WEITERE_EINSTELLUNGEN[] PROGMEM ="Méi Astellungen";
...
const char INTL_MESSINTERVALL[] PROGMEM = "Mooss-intervall";
const char INTL_DAUER_ROUTERMODUS[] PROGMEM = "Zait&nbsp;Routermodus";
const char INTL_WEITERE_APIS[] PROGMEM = "Aner APIs";
const char INTL_AN_EIGENE_API_SENDEN[] PROGMEM = "Un eegen API schécken";
const char INTL_SERVER[] PROGMEM = "Server"; 
const char INTL_PFAD[] PROGMEM = "Wee"; 
const char INTL_PORT[] PROGMEM = "Port"; 
const char INTL_BENUTZER[] PROGMEM = "Benotzer"; 
const char INTL_PASSWORT[] PROGMEM = "Passwuert"; 
const char INTL_SENDEN_AN[] PROGMEM = "Schécken op {v}"; 
const char INTL_LESE[] PROGMEM = "Liesen {v}";
const char INTL_GERAT_WIRD_NEU_GESTARTET[] PROGMEM = "De Sensor gëtt neigestart.";
const char INTL_GERAT_NEU_STARTEN[] PROGMEM = "Apparat nei starten";
const char INTL_CONFIG_LOSCHEN[] PROGMEM = "Config.json läschen";
const char INTL_SENSOR_NEU_STARTEN[] PROGMEM = "Sensor nei starten";
const char INTL_UBERSICHT[] PROGMEM = "Iwwersiicht";
const char INTL_ZURUCK_ZUR_STARTSEITE[] PROGMEM = "Zréck op d'Haaptsäit";
const char INTL_AKTUELLE_WERTE[] PROGMEM = "Aktuell Wäerter";
const char INTL_KARTE_DER_AKTIVEN_SENSOREN[] PROGMEM = "Kaart vun den aktive Sensoren (externen Link)";
const char INTL_KONFIGURATION_LOSCHEN[] PROGMEM = "Konfiguratioun läschen";
const char INTL_KONFIGURATION_WIRKLICH_LOSCHEN[] PROGMEM = "Konfiguratioun wierklech läschen?";
const char INTL_LOSCHEN[] PROGMEM = "Läschen";
...
const char INTL_CONFIG_GELOSCHT[] PROGMEM = "Config.json geläscht";
const char INTL_CONFIG_KONNTE_NICHT_GELOSCHT_WERDEN[] PROGMEM = "Config.json konnt net geläscht ginn";
const char INTL_CONFIG_NICHT_GEFUNDEN[] PROGMEM = "Config.json net fonnt";
const char INTL_ERSTER_MESSZYKLUS[] PROGMEM = "Nach {v} Sekonnen bis zur éischter Miessung.";
const char INTL_ZEIT_SEIT_LETZTER_MESSUNG[] PROGMEM = " Sekonnen zanter der leschter Miessung.";
const char INTL_PARTIKEL_LITER[] PROGMEM = "Partikel/Liter";
const char INTL_FEINSTAUB[] PROGMEM = "Reng Stëbspartikelen";
const char INTL_TEMPERATUR[] PROGMEM = "Temperatur";
const char INTL_LUFTFEUCHTE[] PROGMEM = "rel. Loftfiichtegkeet";
const char INTL_LUFTDRUCK[] PROGMEM = "Loftdrock";
...
const char INTL_QUALITAT[] PROGMEM = "Qualitéit";
const char INTL_ANZAHL_MESSUNGEN[] PROGMEM = "Zuel vu Mesuren:";
const char INTL_SENSOR[] PROGMEM = "Sensor";
const char INTL_PARAMETER[] PROGMEM = "Parameter";
const char INTL_WERT[] PROGMEM = "Wäert";
