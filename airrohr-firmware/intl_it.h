...
const char INTL_DISPLAY_WIFI_INFO[] PROGMEM = "Visuallizza informazioni del wi-fi";
const char INTL_DISPLAY_DEVICE_INFO[] PROGMEM = "Visuallizza informazioni del dispositivo";
