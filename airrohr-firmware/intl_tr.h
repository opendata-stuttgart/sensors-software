...
const char INTL_ENABLE_BATTERY_MONITOR[] PROGMEM = "Pil monitörünü etkinleştir (INA219)";
const char INTL_BATTERY_STATE[] PROGMEM = "Pil durumu";
const char INTL_CURRENT_DRAW[] PROGMEM = "Akım çekişi";
const char INTL_POWER_CONSUMPTION[] PROGMEM = "Güç tüketimi";
...
const char INTL_INA219_SELECT_CALIBRATION[] PROGMEM = "Kalibrasyonu seçin";
