...
const char INTL_LATITUDE[] = "Latitudine";
const char INTL_LONGITUDE[] = "Longitudine";
const char INTL_ALTITUDE[] = "Altitudine";
const char INTL_DATE[] = "Data";
const char INTL_TIME[] = "Tempo";
