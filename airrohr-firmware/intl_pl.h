...
const char INTL_DISPLAY_WIFI_INFO[] PROGMEM = "Info o WiFi";
const char INTL_DISPLAY_DEVICE_INFO[] PROGMEM = "Info o urządzeniu";
...
const char INTL_LA_MIN[] PROGMEM = "LAmin";
const char INTL_LA_MAX[] PROGMEM = "LAmax";
