...
const char INTL_DHT22[] PROGMEM = "DHT22 (temperatur, rel. fuktighet)";
const char INTL_HTU21D[] PROGMEM = "HTU21D (temperatur, rel. fuktighet)";
...
const char INTL_LESE[] PROGMEM = "Hämta";
...
const char INTL_SENSOR_WIRKLICH_NEU_STARTEN[] PROGMEM = "Ska sensorn startas om?";
