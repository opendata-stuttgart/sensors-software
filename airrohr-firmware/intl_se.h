...
const char INTL_ENABLE_BATTERY_MONITOR[] PROGMEM = "Aktivera batteriövervakare (INA219)";
const char INTL_BATTERY_STATE[] PROGMEM = "Batteristatus";
const char INTL_CURRENT_DRAW[] PROGMEM = "Strömdrag";
const char INTL_POWER_CONSUMPTION[] PROGMEM = "Energiförbrukning";
const char INTL_BATTERY_U_MIN[] PROGMEM = "Batteri U min (mV):";
const char INTL_BATTERY_U_MAX[] PROGMEM = "Batteri U max (mV):";
const char INTL_INA219_SELECT_CALIBRATION[] PROGMEM = "Välj kalibrering";
