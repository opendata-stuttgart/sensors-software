...
const char INTL_ENABLE_BATTERY_MONITOR[] PROGMEM = "Активуйте монітор батареї (INA219)";
const char INTL_BATTERY_STATE[] PROGMEM = "Стан батареї";
const char INTL_CURRENT_DRAW[] PROGMEM = "Споживання струму";
const char INTL_POWER_CONSUMPTION[] PROGMEM = "Споживана потужність";
const char INTL_BATTERY_U_MIN[] PROGMEM = "U min на батареї (mV):";
const char INTL_BATTERY_U_MAX[] PROGMEM = "U max на батареї (mV):";
const char INTL_INA219_SELECT_CALIBRATION[] PROGMEM = "Виберіть калібрування";
