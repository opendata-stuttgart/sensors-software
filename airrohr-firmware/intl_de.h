...
const char INTL_POWERSAVE[] PROGMEM = "Energie sparen";
...
const char INTL_VOC[] PROGMEM = "Flüchtige organische Verbindungen";
const char INTL_NOX[] PROGMEM = "Stickstoffoxiden";
